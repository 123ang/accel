  ...
  <div class="add-meeting container z-depth-1">
    ...
    <form @submit.prevent="addMeeting">
      ...
      <div class="field time">
        ...
        From:
        <v-col>
          <input type="time" name="start_time" v-model="start_time" class="time">
        </v-col>
        To:
         <v-col>
          <input type="time" name="end_time" v-model="end_time" class="time">
        </v-col> 
        </v-row>
    
      </div>
      <div v-for="(mem, index) in members" class="field member" :key="index">
        <label for="member">member:</label>
        <input type="text" name="member" v-model="members[index]">
